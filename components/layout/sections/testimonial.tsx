...
const reviewListDesktop: ReviewProps[] = [
 ...
 {
    image: "",
    comment: `استشارة قانونية عن بعد :\nأول ما تبعثلنا مشكلتك نتصلو بيك في ظرف ساعات قليلة على الهاتف\nنوفرولك المعلومات اللازمة كل\nنجاوبوك على أي استفسار اضافي\nوما نسيبوك كان ما فاهم كل شي.`,
}
